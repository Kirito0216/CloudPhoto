...
public class VipsUtil {
    ...
    static String windowsCommand = "F:/SpringCloud/vips-dev-8.14/bin/vipsthumbnail.exe";
    ...
    public  static  void main(String[] args){
        String srcPath = "C:/Users/LENOVO/Desktop/preview.jpg";
        String desPath = "F:/SpringCloud/vips-dev-8.14/img/preview_600.jpg";
        int tarWidth = 600;
        int tarHight = 600;
        String quality ="100";
